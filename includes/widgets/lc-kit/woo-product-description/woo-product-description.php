...
/**
 * Woo Description Widget.
 *
 * Elementor widget that displays a Woo Description.
 */
class LCAKE_Kit_Woo_Product_Description extends \Elementor\Widget_Base {
	...
	public function get_style_depends() {
		return array( 'lcake-kit-woo-product-description-css' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#374151',
				'selectors' => array( '{{WRAPPER}} .lcake-woo-description' => 'color: {{VALUE}};' ),
			)
		);
