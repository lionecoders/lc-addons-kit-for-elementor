<div class="lc-testimonial-slider arrow_inside lc-default-testimonial <?php echo (!empty($lc_testimonial_show_dot) && $lc_testimonial_show_dot === 'yes') ? 'lc-slider-dotted' : '' ?>" <?php $this->print_render_attribute_string('wrapper'); ?>>
			...
			?>
				<div class="swiper-slide">
					<div class="swiper-slide-inner">
						<<?php echo esc_attr($wrapTag); ?> class="lc-testimonial-item" <?php echo $this->get_render_attribute_string('link-' . $testimonial['_id']); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Already escaped by elementor 
																						?>>
							<div class="lc-single-testimonial-slider <?php echo esc_attr(!empty($testimonial['lc_testimonial_active']) ? 'testimonial-active' : ''); ?>">
								<div class="row">
									<div class="col-lg-6 lc-testimonial-col">
									...
									<div class="col-lg-6 lc-testimonial-col">
										<div class="lc-profile-image-card">
