			...
			foreach ( $testimonials as $testimonial ) :
				...
				<div class="swiper-slide">
					<div class="swiper-slide-inner">
						<<?php echo esc_attr( $wrapTag ); ?> class="lcake-testimonial-card" style="background-image: url(<?php echo esc_url( $clientPhoto ); ?>);" 
						<?php
						...
						>
							...
							<span class="lcake-profile-info">
								...
								<?php
								echo isset( $testimonial['designation'] ) ? wp_kses( $testimonial['designation'], \LCAKE_Kit_Utils::get_kses_array() ) : ''; // phpcs:ignore WordPress.Security.EscapeOutput -- Already escaped by kspan method by lcake-kit 
								?>
								</span>
							</span>
