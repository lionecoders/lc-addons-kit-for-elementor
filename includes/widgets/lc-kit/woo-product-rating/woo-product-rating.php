...
class LCAKE_Kit_Woo_Product_Rating extends \Elementor\Widget_Base
{
	...
	{
		return 'eicon-product-rating lcake-mveous-badge';
	}

	public function get_style_depends()
	{
		return array('lcake-kit-woo-product-rating-css');
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			array(
				...
				'default' => '#facc15',
				'selectors' => array('{{WRAPPER}} .lcake-woo-product-rating .star-rating span::before' => 'color: {{VALUE}};'),
				'separator' => 'before',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .lcake-woo-product-rating .star-rating' => 'font-size: {{SIZE}}px; height: 1em; line-height: 1;',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .lcake-woo-product-rating .star-rating::before, {{WRAPPER}} .lcake-woo-product-rating .star-rating span::before' => 'letter-spacing: {{SIZE}}px;',
					'{{WRAPPER}} .lcake-woo-product-rating .star-rating' => 'width: calc(5.4em + ({{SIZE}}px * 4.5));',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '#6b7280',
				'selectors' => array('{{WRAPPER}} .lcake-woo-product-rating-count' => 'color: {{VALUE}};'),
				'condition' => array(
					'show_count' => 'yes',
				),
			)
