...
class LCAKE_Kit_Twitter_Feed extends \Elementor\Widget_Base {
    ...
    public function get_style_depends() {
        return ['lcake-kit-twitter-feed-css'];
    }

    public function get_script_depends() {
        return ['lcake-kit-twitter-feed-js'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'light',
                'options' => ['light' => esc_html__('Light', 'lc-addons-kit-for-elementor'), 'dark' => esc_html__('Dark', 'lc-addons-kit-for-elementor')],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => ['{{WRAPPER}} .lcake-twitter-feed' => 'height: {{SIZE}}{{UNIT}};'],
            ]
        );
