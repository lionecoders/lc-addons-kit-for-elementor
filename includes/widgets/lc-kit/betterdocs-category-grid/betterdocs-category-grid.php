    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#ffffff',
                'selectors' => ['{{WRAPPER}} .lcake-docs-category-grid-column' => 'background-color: {{VALUE}};'],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#111827',
                'selectors' => ['{{WRAPPER}} .lcake-docs-category-grid-title a' => 'color: {{VALUE}};'],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#3b82f6',
                'selectors' => ['{{WRAPPER}} .lcake-docs-category-grid-title a:hover' => 'color: {{VALUE}};'],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#374151',
                'selectors' => ['{{WRAPPER}} .lcake-docs-category-grid-list a' => 'color: {{VALUE}};'],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#3b82f6',
                'selectors' => ['{{WRAPPER}} .lcake-docs-category-grid-list a:hover' => 'color: {{VALUE}};'],
            ]
        );
