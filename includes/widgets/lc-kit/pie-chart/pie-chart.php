...
class LCAKE_Kit_Pie_Chart extends \Elementor\Widget_Base {
	...
	public function get_keywords() {
		return array( 'pie', 'chart', 'graph', 'data', 'visualization' );
	}

	// This must match your registered script handle in enqueue code (see below)
	public function get_script_depends() {
		return array( 'lcake-kit-pie-chart' );
	}
	...
	protected function add_content_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'default'     => array(
					array(
						'label' => esc_html__( 'Profit', 'lc-addons-kit-for-elementor' ),
						'value' => 50,
						'color' => '#35c048',
					),
					array(
						'label' => esc_html__( 'Lose', 'lc-addons-kit-for-elementor' ),
						'value' => 30,
						'color' => '#ed2424',
					),
					array(
						'label' => esc_html__( 'Investment', 'lc-addons-kit-for-elementor' ),
						'value' => 20,
						'color' => '#7068ff',
					),
				),
