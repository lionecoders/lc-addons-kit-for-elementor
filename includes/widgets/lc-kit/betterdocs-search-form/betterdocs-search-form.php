...
class LCAKE_Kit_Betterdocs_Search_Form extends \Elementor\Widget_Base {
    ...
    public function get_keywords() {
        return ['lc', 'lcake', 'betterdocs', 'docs', 'search', 'form'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => ['{{WRAPPER}} .lcake-docs-search-input' => 'background-color: {{VALUE}};'],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => ['{{WRAPPER}} .lcake-docs-search-input' => 'color: {{VALUE}};'],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#3b82f6',
                'selectors' => ['{{WRAPPER}} .lcake-docs-search-button' => 'background-color: {{VALUE}}; transition: all 0.3s ease;'],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#ffffff',
                'selectors' => ['{{WRAPPER}} .lcake-docs-search-button' => 'color: {{VALUE}};'],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Background Color', 'lc-addons-kit-for-elementor'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => ['{{WRAPPER}} .lcake-docs-search-button:hover' => 'background-color: {{VALUE}};'],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Text Color', 'lc-addons-kit-for-elementor'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => ['{{WRAPPER}} .lcake-docs-search-button:hover' => 'color: {{VALUE}};'],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => ['{{WRAPPER}} .lcake-docs-search-button:hover' => 'border-color: {{VALUE}};'],
            ]
        );
