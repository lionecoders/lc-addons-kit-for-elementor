...
class LCAKE_Kit_Image_Comparison extends \Elementor\Widget_Base {
	...
	public function get_keywords() {
		return array( 'image', 'comparison', 'before', 'after', 'slider', 'overlay' );
	}

	public function get_script_depends() {
		return array( 'lcake-kit-image-comparison', 'lcake-kit-twentytwenty', 'lcake-kit-jquery-event-move' );
	}

	public function get_style_depends() {
		return array( 'lcake-kit-image-comparison', 'lcake-kit-twentytwenty' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'lcake_img_comparison_label_before',
			array(
				'label'     => esc_html__( 'Before Label', 'lc-addons-kit-for-elementor' ),
				'type'      => \Elementor\Controls_Manager::TEXT,
				'default'   => 'Before',
				'selectors' => array(
		...
		$this->add_control(
			'lcake_img_comparison_label_after',
			array(
				'label'     => esc_html__( 'After Label', 'lc-addons-kit-for-elementor' ),
				'type'      => \Elementor\Controls_Manager::TEXT,
				'default'   => 'After',
				'selectors' => array(
		...
		$this->start_controls_section(
			...
			array(
				...
				'tab'        => \Elementor\Controls_Manager::TAB_STYLE,
				'show_label' => false,
				'condition'  => array( 'lcake_img_comparison_overlay!' => 'yes' ),
			)
		);
