...
class LCAKE_Kit_Type_Form extends \Elementor\Widget_Base {
	...
	public function get_style_depends() {
		return array( 'lcake-kit-type-form-css' );
	}

	public function get_script_depends() {
		return array( 'lcake-kit-type-form-js' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'condition' => array( 'embed_type' => 'popup' ),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'condition' => array( 'embed_type' => 'widget' ),
				'selectors' => array( '{{WRAPPER}} .lcake-typeform-widget' => 'height: {{SIZE}}{{UNIT}};' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#ffffff',
				'selectors' => array( '{{WRAPPER}} .lcake-typeform-button' => 'color: {{VALUE}};' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'default'   => '#3b82f6',
				'selectors' => array( '{{WRAPPER}} .lcake-typeform-button' => 'background-color: {{VALUE}};' ),
			)
		);
