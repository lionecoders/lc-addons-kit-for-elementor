 ...
 * Data Table Widget.
 *
 * Elementor widget that displays a Data Table.
 */
class LCAKE_Kit_Data_Table extends \Elementor\Widget_Base {
	...
	public function get_icon() {
		return 'eicon-table lcake-mveous-badge';
	}

	public function get_style_depends() {
		return array( 'lcake-kit-data-table-css' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'default'     => array(
					array( 'column_label' => esc_html__( 'Plan', 'lc-addons-kit-for-elementor' ) ),
					array( 'column_label' => esc_html__( 'Price', 'lc-addons-kit-for-elementor' ) ),
					array( 'column_label' => esc_html__( 'Storage', 'lc-addons-kit-for-elementor' ) ),
				),
		...
		$this->add_control(
			...
			array(
				...
				'default'     => array(
					array( 'row_cells' => esc_html__( 'Basic, $10/mo, 10GB', 'lc-addons-kit-for-elementor' ) ),
					array( 'row_cells' => esc_html__( 'Pro, $25/mo, 100GB', 'lc-addons-kit-for-elementor' ) ),
					array( 'row_cells' => esc_html__( 'Enterprise, $50/mo, 1TB', 'lc-addons-kit-for-elementor' ) ),
				),
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#3b82f6',
				'selectors' => array( '{{WRAPPER}} .lcake-data-table thead th' => 'background-color: {{VALUE}};' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'default'   => '#ffffff',
				'selectors' => array( '{{WRAPPER}} .lcake-data-table thead th' => 'color: {{VALUE}};' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'default'   => '#f9fafb',
				'selectors' => array( '{{WRAPPER}} .lcake-data-table.is-striped tbody tr:nth-child(even)' => 'background-color: {{VALUE}};' ),
			)
		);
