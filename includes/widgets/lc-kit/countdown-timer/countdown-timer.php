...
class LCAKE_Kit_Countdown_Timer extends Widget_Base {
	...
	public function get_script_depends() {
		return array( 'lcake-kit-countdown-js', 'lcake-kit-countdown-timer-js' );
	}
	...
	public function get_keywords() {
		return array( 'countdown', 'timer', 'clock', 'time', 'deadline' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'condition' => array( 'lcake_countdown_timer_style' => 'style3' ),
			)
		);
