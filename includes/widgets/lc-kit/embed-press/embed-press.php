...
class LCAKE_Kit_Embed_Press extends \Elementor\Widget_Base {
	...
	public function get_style_depends() {
		return array( 'lcake-kit-embed-press-css' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .lcake-embed-press iframe' => 'height: {{SIZE}}{{UNIT}};' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array( '{{WRAPPER}} .lcake-embed-press' => 'border-radius: {{SIZE}}{{UNIT}}; overflow: hidden;' ),
			)
		);
