    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    ['column_label' => esc_html__('Status', 'lc-addons-kit-for-elementor')],
                    ['column_label' => esc_html__('Signal Name', 'lc-addons-kit-for-elementor')],
                    ['column_label' => esc_html__('Severity', 'lc-addons-kit-for-elementor')],
                    ['column_label' => esc_html__('Stage', 'lc-addons-kit-for-elementor')],
                    ['column_label' => esc_html__('Schedule', 'lc-addons-kit-for-elementor')],
                    ['column_label' => esc_html__('Team Lead', 'lc-addons-kit-for-elementor')],
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    ['row_cells' => 'No signal, Astrid: NE shared managed, Medium, Triaged, 0:33, Chase Nguyen'],
                    ['row_cells' => 'Offline, Cosmo: prod shared ares, Huge, Triaged, 0:39, Brie Furman'],
                    ['row_cells' => 'Online, Phoenix: prod shared lyra-lists, Minor, Not triaged, 3:12, Jeremy Lake'],
                    ['row_cells' => 'Online, Sirius: NW prod shared locations, Negligible, Triaged, 13:18, Angelica Howards'],
                    ['row_cells' => 'Online, Sirius: prod independent account, Negligible, Triaged, 22:06, Diane Okuma'],
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#ffffff',
                'selectors' => ['{{WRAPPER}} .lcake-adv-table tbody tr:nth-child(odd)' => 'background-color: {{VALUE}};'],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#fafbfc',
                'selectors' => ['{{WRAPPER}} .lcake-adv-table tbody tr:nth-child(even)' => 'background-color: {{VALUE}};'],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => ['{{WRAPPER}} .lcake-adv-table tbody tr:hover' => 'background-color: {{VALUE}};'],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#475569',
                'selectors' => ['{{WRAPPER}} .lcake-adv-table tbody td' => 'color: {{VALUE}};'],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => ['{{WRAPPER}} .lcake-adv-table-search' => 'border-color: {{VALUE}};'],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#3b82f6',
                'selectors' => ['{{WRAPPER}} .lcake-adv-table-search:focus' => 'border-color: {{VALUE}};'],
            ]
        );
