...
class LCAKE_Kit_Dual_Color_Header extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('LC Dual Color Header', 'lc-addons-kit-for-elementor');
    }
    ...
    public function get_style_depends() {
        return ['lcake-kit-dual-color-header-css'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'left',
                'selectors' => ['{{WRAPPER}} .lcake-dual-color-header' => 'text-align: {{VALUE}};'],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#111827',
                'selectors' => ['{{WRAPPER}} .lcake-dual-color-header-part-one' => 'color: {{VALUE}};'],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#3b82f6',
                'selectors' => ['{{WRAPPER}} .lcake-dual-color-header-part-two' => 'color: {{VALUE}};'],
            ]
        );
    ...
    protected function render() {
        ...
        $valid_tags = ['h1', 'h2', 'h3', 'h4', 'div', 'span'];
