	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<button type="button" class="lcake-team-modal-close <?php echo esc_attr( $close_btn_align_class ); ?>" aria-label="Close" data-bs-dismiss="modal">
				<?php
				if ( ! empty( $lcake_team_close_icon_changes ) && is_array( $lcake_team_close_icon_changes ) ) {
					\Elementor\Icons_Manager::render_icon( $lcake_team_close_icon_changes, array( 'aria-hidden' => 'true' ) );
				} else {
					?>
