...
class LCAKE_Kit_Team extends \Elementor\Widget_Base {
    ...
    protected function render_template( ) {
		...
		$this->add_render_attribute(
			'profile_card',
			[
				'class' => 'profile-card elementor-animation-'. $team_hover_animation .' ' . $lcake_team_content_text_align . ' lcake-team-style-'.$lcake_team_style,
			]
		);
		...
		?>
		<?php if($lcake_team_style == 'centered_style'): ?> <div class="profile-square-v"> <?php endif; ?>
		<?php if($lcake_team_style == 'centered_style_details'): ?> <div class="profile-square-v square-v5 no_gutters"> <?php endif; ?>
		<?php if($lcake_team_style == 'long_height_details'): ?> <div class="profile-square-v square-v6 no_gutters"> <?php endif; ?>
		<?php if($lcake_team_style == 'long_height_details_hover'): ?> <div class="profile-square-v square-v6 square-v6-v2 no_gutters"><?php endif; ?>
		...
		<div <?php echo $this->get_render_attribute_string('profile_card'); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Already escaped by elementor ?>>
			...
			<?php endif; ?>
				...
				<div class="profile-body">
					...
					<div class="profile-icon<?php echo esc_attr($lcake_team_top_icon_align) ? ' icon-align-'.esc_attr($lcake_team_top_icon_align) : ''; ?>">
					...
					<p class="profile-designation"><?php echo esc_html( $lcake_team_position ); ?></p>
					<?php if($lcake_team_show_short_description == 'yes' && $lcake_team_short_description != ''): ?>
					<p class="profile-content"><?php echo wp_kses($lcake_team_short_description, \LCAKE_Kit_Utils::get_kses_array()); ?></p>
					<?php endif;?>
				...
				<?php if(in_array($lcake_team_style, array('centered_style', 'centered_style_details', 'long_height_details', 'long_height_details_hover')) ): ?> </div> <?php endif; ?>
			<?php endif; ?>

			<?php if ( in_array($lcake_team_style, array('overlay', 'overlay_details', 'long_height_hover', 'overlay_circle', 'overlay_circle_hover')) ): ?>
				<?php if($lcake_team_style == 'overlay_details'): ?> <div class="image-card-v2"> <?php endif; ?>
				<?php if($lcake_team_style == 'long_height_hover'): ?> <div class="<?php echo esc_attr($settings['lcake_team_remove_gutters'] == 'yes' ? '' : 'small-gutters'); ?> image-card-v3"> <?php endif; ?>
				<?php if($lcake_team_style == 'overlay_circle'): ?> <div class="style-circle lcake-team-img-fit"> <?php endif; ?>
				<?php if($lcake_team_style == 'overlay_circle_hover'): ?> <div class="image-card-v2 style-circle"> <?php endif; ?>
					<div class="profile-image-card elementor-animation-<?php echo esc_attr($team_hover_animation) ?> lcake-team-img lcake-team-style-<?php echo esc_attr($lcake_team_style); ?> <?php if(isset($lcake_team_content_text_align)) { echo esc_attr($lcake_team_content_text_align);} ?>">
					...
					<?php if(in_array($lcake_team_style, array('overlay_details', 'long_height_hover' , 'overlay_circle', 'overlay_circle_hover')) ): ?> </div> <?php endif; ?>
				...
				<div class="profile-square-v square-v4 elementor-animation-<?php echo esc_attr($team_hover_animation) ?> lcake-team-style-<?php echo esc_attr($lcake_team_style); ?>">
					<div class="profile-card <?php if(isset($lcake_team_content_text_align)) { echo esc_attr($lcake_team_content_text_align);} ?>">
						<div class="profile-header lcake-team-img" <?php if ($settings['lcake_team_chose_popup'] == 'yes') :?> data-bs-toggle="modal" data-bs-target="#lcake_team_modal_<?php echo esc_attr($this->get_id() . '_' . get_the_ID()); ?>" <?php endif; ?>>
							<?php echo wp_kses($image_html, \LCAKE_Kit_Utils::get_kses_array()); ?>
						</div><!-- .profile-header END -->
						<div class="profile-body">
							<h2 class="profile-title">
