...
class LCAKE_Kit_Progress_Bar extends \Elementor\Widget_Base {
	...
	public function get_icon() {
		return 'eicon-skill-bar lcake-mveous-badge';
	}
	...
	public function get_keywords() {
		return array( 'progress', 'bar', 'skill', 'percentage', 'meter' );
	}

	public function get_script_depends() {
		return array( 'lcake-kit-progress-bar-js' );
	}

	public function get_style_depends() {
		return array( 'lcake-kit-progress-bar-css' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'condition'        => array(
					'lcake_progressbar_style' => array( 'inner-content skill-big' ),
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'separator'  => 'before',
				'condition'  => array(
					'lcake_progressbar_style!' => array( 'style-switch' ),
				),
				'selectors'  => array(
		...
		$this->add_group_control(
			...
			array(
				...
				'condition' => array(
					'lcake_progressbar_style!' => array( 'style-stripe skill-medium tooltip-style' ),
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'condition' => array(
					'lcake_progressbar_style' => array( 'tooltip-style', 'style-stripe skill-medium tooltip-style' ),
				),
				'selectors' => array(
		...
		$this->add_responsive_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'condition' => array(
					'lcake_progressbar_style' => array( 'style-ribbon', 'pin-style', 'tooltip-style2', 'tooltip-style3' ),
				),
				'selectors' => array(
					...
					<?php if ( 'style-switch' != $lcake_progressbar_style ) : ?>
						...
						<div class="lcake-bar">
							<div class="lcake-bar-track">
								<?php
								if ( 'inner-content skill-big' == $lcake_progressbar_style ) :
									...
									<span class="lcake-bar-icon">
										<?php
										if ( $is_new || $migrated ) {
											\Elementor\Icons_Manager::render_icon( $settings['lcake_progressbar_icons'], array( 'aria-hidden' => 'true' ) );
										} else {
											?>
