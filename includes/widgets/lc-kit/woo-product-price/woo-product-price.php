...
class LCAKE_Kit_Woo_Product_Price extends \Elementor\Widget_Base {
	...
	public function get_icon() {
		return 'eicon-product-price lcake-mveous-badge';
	}

	public function get_style_depends() {
		return array( 'lcake-kit-woo-product-price-css' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'default'   => '#3b82f6',
				'selectors' => array( '{{WRAPPER}} .lcake-woo-product-price' => 'color: {{VALUE}};' ),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .lcake-woo-product-price' => 'text-align: {{VALUE}};'
				),
			)
		);
