...
class LCAKE_Kit_Simple_Menu extends \Elementor\Widget_Base {
    ...
    public function get_style_depends() {
        return ['lcake-kit-simple-menu-css'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    ['menu_text' => esc_html__('Home', 'lc-addons-kit-for-elementor')],
                    ['menu_text' => esc_html__('About', 'lc-addons-kit-for-elementor')],
                    ['menu_text' => esc_html__('Services', 'lc-addons-kit-for-elementor')],
                    ['menu_text' => esc_html__('Contact', 'lc-addons-kit-for-elementor')],
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#111827',
                'selectors' => ['{{WRAPPER}} .lcake-simple-menu-item a' => 'color: {{VALUE}};'],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#3b82f6',
                'selectors' => ['{{WRAPPER}} .lcake-simple-menu-item a:hover' => 'color: {{VALUE}};'],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => ['{{WRAPPER}} .lcake-simple-menu' => 'gap: {{SIZE}}{{UNIT}};'],
            ]
        );
