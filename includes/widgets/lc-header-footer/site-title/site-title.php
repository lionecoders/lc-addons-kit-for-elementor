...
class LC_Header_Footer_Site_Title extends \Elementor\Widget_Base {
    ...
    public function get_style_depends() {
        return ['lc-header-footer-site-title-css'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'h2',
                'options' => ['h1' => 'H1', 'h2' => 'H2', 'h3' => 'H3', 'div' => 'div', 'span' => 'span'],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#111827',
                'selectors' => ['{{WRAPPER}} .lc-hf-site-title' => 'color: {{VALUE}};'],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => ['{{WRAPPER}} .lc-hf-site-tagline' => 'color: {{VALUE}};'],
            ]
        );
