...
class LC_Header_Footer_Cart_Icon extends \Elementor\Widget_Base {
    ...
    public function get_style_depends() {
        return ['lc-header-footer-cart-icon-css'];
    }

    public function get_script_depends() {
        return ['lc-header-footer-cart-icon-js'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#111827',
                'selectors' => ['{{WRAPPER}} .lc-hf-cart-icon-btn' => 'color: {{VALUE}};'],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#3b82f6',
                'selectors' => ['{{WRAPPER}} .lc-hf-cart-count' => 'background-color: {{VALUE}};'],
            ]
        );
